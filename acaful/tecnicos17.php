                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12 card-box">
                                <h4 class="page-title">Técnicos Sub-17</h4><br>  <a href="add_tecnicos.php" class="btn btn-primary"> <i class = "fa fa-plus"></i> ADICIONAR TÉCNICO</a>
                            </div>
                                <hr>
                        ...
                        $query = mysql_query("SELECT *, timec.Nome_time FROM tecnico INNER JOIN timec ON tecnico.timetecnico = timec.id_times WHERE categoria_time = 6" );

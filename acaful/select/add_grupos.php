...
<head>
    ...
    <body class="fixed-left">
            ...
            <div class="content-page">
                ...
                <form method="POST" action="../cadastra_grupo.php" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col">
                                    <label>Nome do Grupo</label>
                                    <input name="grupo" type="text" class="form-control" placeholder="Exemplo: Grupo 1" required="" style="width: 300px;">
                                    </div>
                        ...
                        $query = "SELECT *, categoria.Categoria FROM timec INNER JOIN categoria ON timec.categoria_time = categoria.idCategoria";

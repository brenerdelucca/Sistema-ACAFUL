    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <form method="POST" action="update_jogador.php" enctype="multipart/form-data">
            <input type="hidden" name="id_jogadores" value="<?php echo $coluna['id_jogadores'];?>">
                                ...
                                <div class="row">
                                    ...
                                    <input value="<?php echo $coluna['cartoes_amarelos'];?>" name="CA" type="number" class="form-control"  required="" style="width: 300px;">
                                    </div>
                                    <div class="col">

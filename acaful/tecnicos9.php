...
<head>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12 card-box">
                                <h4 class="page-title">Técnicos Sub-09</h4><br>  <a href="add_tecnicos.php" class="btn btn-primary"> <i class = "fa fa-plus"></i> ADICIONAR TÉCNICO</a>
                            </div>
                                <hr>
                        ...
                        $query = mysql_query("SELECT *, timec.Nome_time FROM tecnico INNER JOIN timec ON tecnico.timetecnico = timec.id_times WHERE categoria_time = 2" );
            ...
            <div>
             <a style="width: 150px;" class="btn btn-secondary" href="deletar_tecnico.php?id=<?php echo $coluna['id_tecnico'];?>" onclick="return confirm('Você tem certeza?')" role="button">Excluir</a>
            </div>

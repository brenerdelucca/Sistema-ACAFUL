      ...
      <div class="container align-items-center">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <span class="subheading">SUB-7</span>
              ...
              <table class="table table-hover table-striped">
                <thead class="thead-primary">
                  ...
                  $query = mysql_query("SELECT *, timec.Nome_time FROM jogador
                                        ...
                                        WHERE categoria_time = 1 ORDER BY gols desc");
              ...
              <table class="table table-hover table-striped">
                <thead class="thead-primary">
                  ...
                  $query2 = mysql_query("SELECT *, timec.Nome_time FROM jogador
                                        INNER JOIN timec
                                        ON jogador.timejogador = timec.id_times 
                                        WHERE categoria_time = 1 ORDER BY cartoes_amarelos desc");
            ...
            <div class="table-responsive">
              <table class="table table-hover table-striped">
                ...
                <tbody>
                  <?php
                        include('conexao.php');
                        $query1 = mysql_query("SELECT * FROM resultado_jogo INNER JOIN timec ON timec.id_times = resultado_jogo.time_a WHERE categoria_jogo = 1");

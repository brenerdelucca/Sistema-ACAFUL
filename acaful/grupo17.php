                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12 card-box">
                                <h4 class="page-title">Grupos Sub-17</h4><br>  <a href="select/add_grupos.php" class="btn btn-primary"> <i class = "fa fa-plus"></i> ADICIONAR GRUPO</a>
                            </div>
                                <hr>
                        <?php
                        include('conexao.php');
                        $query = mysql_query("SELECT * FROM grupos WHERE categoria_grupo = 6 GROUP BY grupo");
                        ...
                        <div class="col-sm-4 card-box">
                         ...
                         <?php
                         include('conexao.php');
                         $query2 = mysql_query("SELECT * FROM grupos WHERE grupo = '$birl' AND categoria_grupo = 6 ");

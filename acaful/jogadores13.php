...
<head>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12 card-box">
                                <h4 class="page-title">Jogadores Sub-13</h4><br>  <a href="add_jogadores.php" class="btn btn-primary"> <i class = "fa fa-plus"></i> ADICIONAR JOGADOR</a>
                            </div>
                                <hr>
            ...
            <?php
                            include('conexao.php');
        $query4 = mysql_query("SELECT *, timec.Nome_time FROM jogador INNER JOIN timec ON jogador.timejogador = timec.id_times WHERE categoria_time = 4 AND posicao = 1  ORDER BY Nome_time");
            ...
            <?php
                            include('conexao.php');
        $query4 = mysql_query("SELECT *, timec.Nome_time FROM jogador INNER JOIN timec ON jogador.timejogador = timec.id_times WHERE categoria_time = 4 AND posicao = 2 ORDER BY Nome_time");
                        while ($coluna4 = mysql_fetch_array($query4)){ ?>
            <tbody>
                <tr>
                <th style="text-align: left; font-size: 20px;" valign="bottom"><?php echo $coluna4['nome_jogador'];?></th>

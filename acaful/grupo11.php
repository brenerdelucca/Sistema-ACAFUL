            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <?php
                        include('conexao.php');
                        $query = mysql_query("SELECT * FROM grupos WHERE categoria_grupo = 3 GROUP BY grupo");
                        ...
                        <div class="col-sm-4 card-box">
                         ...
                         <?php
                         include('conexao.php');
                         $query2 = mysql_query("SELECT * FROM grupos WHERE grupo = '$birl' AND categoria_grupo = 3 ");

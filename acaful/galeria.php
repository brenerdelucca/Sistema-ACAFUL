            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <form action="cadastrar_fotos.php" method="POST" enctype="multipart/form-data">
                        ...
                        <label for="ft">Adicionar Uma Nova Foto</label>
                        <input type="file" name="img" required="" class="form-control-file" id="ft"><br>
            ...
            <img class="card-img-top" data-src="holder.js/fotos/galeria/<?php echo $cong['arquivo']?>" alt="Thumbnail [100%x225]" style="height: 225px; width: 100%; display: block;" src="fotos/galeria/<?php echo $cong['arquivo']?>" data-holder-rendered="true">
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                     <a href="deletar_foto.php?id=<?php echo $cong['idgaleria'];?>"> <button style="width: 80px;" type="button" class="btn btn-sm btn-outline-secondary" onclick="return confirm('Você tem certeza?')"> Excluir </button> </a>
                      <a href="editar_foto.php?id=<?php echo $cong['idgaleria'];?>"> <button style="width: 80px; type="button" class="btn btn-sm btn-outline-secondary">Editar</button></a>
                    </div>

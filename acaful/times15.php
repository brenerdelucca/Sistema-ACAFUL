                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12 card-box">
                                <h4 class="page-title">Times Sub-15</h4><br>  <a href="add_times.php" class="btn btn-primary"> <i class = "fa fa-plus"></i> ADICIONAR TIME</a>
                            </div>
                                <hr>
                        <?php
                                include("conexao.php");

                        $query2 = mysql_query("SELECT * FROM timec WHERE categoria_time = 5" );
